...
public enum Times {
    ...
    public static Times getById(int id) {
        final Times[] values = Times.values();
        return values[id];
    }
    ...
    public static Times stringToClassTime(String timeString)
    {
        ...
        for(Times timeShift : Times.values())
        {
            if(timeShift.id == id)
            {
                return timeShift;
